...
<html>
    <head>
        ...
        <title>Report Product Stock Left page</title>
    </head>
        <body>
            ...
            <div id="myMain">
            <h2>Report Product Stock Left</h2><br><br><br>
            ...
            <table id="store">
                <tr>
                  ...
                  <th id="stock">STOCK<img src="filterW.png"></th>
                  <th id="totalPurchased">TOTAL PURCHASED<img src="filterW.png"></th>
                  <th id="stockRemaining">STOCK REMAINING<img src="filterW.png"></th>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
