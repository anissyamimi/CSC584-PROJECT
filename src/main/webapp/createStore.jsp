...
<div id="myMain">
        <h2>CREATE STORE</h2>
        <form id="create" method="post" action="StoreHandler">
            <label for="storeName">Store Name</label>
            <input type="text" id="storeName" name="storeName"><br>
            
            <label for="status" class="status">Status</label>
            
            <input type="checkbox" id="status1" name="storeStatus" value="ACTIVE">
            <label for="status1"><span class="status1">&#9679;</span>ACTIVE</label>
            
            <input type="checkbox" id="status2" name="storeStatus" value="INACTIVE">
