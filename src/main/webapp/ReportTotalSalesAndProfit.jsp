...
<html>
    <head>
        ...
        <title>Report Total Sales and Profit page</title>
    </head>
        <body>
            ...
            <div id="myMain">
            <h2>Report of Total Sales and Profit</h2><br><br><br>
            ...
            <table id="store">
                <tr>
                  <th id="yearMonth">YEAR-MONTH <img src="filterW.png"></th>
                  <th id="totalSales">TOTAL SALES (RM) <img src="filterW.png"></th>
                  <th id="profit">PROFIT (RM)<img src="filterW.png"></th>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
