...
<html>
    <head>
        ...
        <title>List of store page</title>
    </head>
        <body>
...
<br>
            ...
            <table id="store" style="text-align: center;">
                <tr>
                  <th onclick="sortTable(0)" id="storeID">STORE ID </th>
                  <th onclick="sortTable(1)" id="storeName">STORE NAME </th>
                  <th onclick="sortTable(2)" id="storeStatus">STORE STATUS </th>
                  <th>ACTION </th>
                </tr>
                
                <c:forEach var="result" items="${oc.rows}">
                <tr>
                  <td class="storeID"><c:out value="${result.storeID}"/></td>
                  <td class="storeName" id="storeName"><c:out value="${result.storeName}"/></td>
                  <td class="storeStatus"><c:out value="${result.storeStatus}"/></td>
                  
                  <td class="action">
					<form method="post">
						<button  class="action1" type="update" formaction="updateStore.jsp?id=${result.storeID}">&#128393;
						</button>
					</form>
					<form method="post">
						<input type="hidden" name="storeID" value="${result.storeID}">
						<input type="hidden" name="action" value="deleteStore">
						<button  class="action1" type="delete" formaction="StoreHandler" onclick="return confirm('Are you sure you want to delete?')">&#128465;</button>
					</form>
				</td>
                </tr>
                </c:forEach>
