...
<html>
    <head>
        ...
        <title>List of orders page</title>
    </head>
        <body>
            ...
            <div id="myMain">
            <h2>ORDER</h2><br>
            <a href="createOrder.jsp" class="btn">CREATE ORDER</a><br><br>
            ...
            <table id="store">
                <tr>
                  <th id="orderID">ORDER ID <img src="filterW.png"></th>
                  <th id="orderDate">ORDER DATE <img src="filterW.png"></th>
                  <th id="orderTime">ORDER TIME <img src="filterW.png"></th>
                  <th id="orderQuantity">ORDER QUANTITY <img src="filterW.png"></th>
                  <th id="custName">CUSTOMER NAME <img src="filterW.png"></th>
                  <th id="prodName">PRODUCT NAME <img src="filterW.png"></th>
                  <th id="staffName">STAFF NAME <img src="filterW.png"></th>
                  <th id="orderPaid">PAID STATUS <img src="filterW.png"></th>
                  <th id="action">ACTION <img src="filterW.png"></th>
                </tr>
                <tr>
                  <td><a href="orderDetails.jsp">ODR001</a></td>
                  <td>20/7/21</td>
                  <td>14:30</td>
                  <td></td>
                  <td></td>
                  ...
                  <td></td>
                  <td></td>
                  <td class="action"><a onclick="printPage()">&#128438;&nbsp;</a><a href="updateOrder.jsp">&#128393;</a>
